...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post auctions_url, params: { auction: { description: @auction.description, end_date: @auction.end_date, start_date: @auction.start_date, title: @auction.title } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { description: @auction.description, end_date: @auction.end_date, start_date: @auction.start_date, title: @auction.title } }
